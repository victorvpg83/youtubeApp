...
export enum ChannelID {
    UCgfyNqU6WIfxd9KfXe7M8LQ = "UCgfyNqU6WIfxd9kfXe7M8LQ",
}

export enum ChannelTitle {
    ReviveTuMoto = "Revive tu moto",
}

export enum PlaylistID {
    UUgfyNqU6WIfxd9KfXe7M8LQ = "UUgfyNqU6WIfxd9kfXe7M8LQ",
}
...
const typeMap: any = {
    ...
    "ChannelID": [
        "UCgfyNqU6WIfxd9kfXe7M8LQ",
    ],
    "ChannelTitle": [
        "Revive tu moto",
    ],
    "PlaylistID": [
        "UUgfyNqU6WIfxd9kfXe7M8LQ",
    ],
    "ResourceIDKind": [
        "youtube#video",
    ],
